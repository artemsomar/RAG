...
async def get_document_by_id(document_id: int, user: User, session: AsyncSession) -> Document | None:
...
async def create_document(document_in: DocumentCreate, user: User, session: AsyncSession) -> Document:
