...
from src.rag.text_processing.tokenizing_processor import TokenizingProcessor
...
class BM25:
    ...
    def search_best(self, query):
        tokenizator = TokenizingProcessor()
        tokenized_corpus =  tokenizator.get_tokenized_corpus(self.df)
        bm25 = BM25Okapi(tokenized_corpus)
        tokenized_query = tokenizator.get_tokenized_query(query)
